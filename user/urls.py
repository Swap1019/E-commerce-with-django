...
urlpatterns = [
    ...
    path('shop/addproduct/addcolor/<int:pk>',ProductColorAddView.as_view(),name='add_color'),
    ...
    path('shop/product-update/imageslist/<int:pk>',ProductImagesListView.as_view(),name='list_image'),
    path('shop/product-update/colorslist/<int:pk>',ProductColorListView.as_view(),name='list_color'),
    path('shop/product-update/imageslist/updateimage/<int:pk>',ProductImagesUpdateView.as_view(),name='update_image'),
    path('shop/product-update/imageslist/deleteimage/<int:pk>',ProductImagesDeleteView.as_view(),name='delete_image'),
    path('shop/product-update/colorslist/deletecolor/<int:id>',ProductColorsDeleteView.as_view(),name='delete_color'),
