    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('national_code', models.CharField(help_text='Your National Code must be 10 digits', max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(default='User', max_length=50, verbose_name='Nick Name')),
                ('is_seller', models.CharField(choices=[('N', 'Not accepted'), ('I', 'Investigate'), ('A', 'Accepted')], default='N', max_length=1, verbose_name='seller')),
